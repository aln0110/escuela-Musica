...
if (isset($_POST['create'])) {
    if (isset($_POST['nombre']) && isset($_POST['apellido']) && isset($_POST['telefono']) 
        ...
        if (strlen($nombre) > 0 && strlen($apellido) > 0 && strlen($telefono) > 0 
    ...
    if (isset($_POST['idEstudiante']) && isset($_POST['nombre']) && isset($_POST['apellido']) 
        ...
        if (strlen($idEstudiante) > 0 && strlen($nombre) > 0 && strlen($apellido) > 0 
